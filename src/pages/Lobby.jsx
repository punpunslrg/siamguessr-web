  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 to-indigo-600">
      <div className="flex flex-col items-center space-y-8 md:space-y-0 md:flex-row md:space-x-12">
        ...
        {/* Invite Card */}
        <div className="bg-gray-200 p-8 rounded-2xl shadow-xl flex flex-col items-center justify-center h-64 w-64 md:h-72 md:w-72 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl border border-gray-300">
          <button className="bg-lime-500 text-white text-xl font-bold py-4 px-8 rounded-full shadow-lg hover:bg-lime-600 transition duration-300 ease-in-out transform hover:scale-105 active:scale-95">
            INVITE
          </button>
        </div>
      </div>
